...
?>
     ...
     <div class="w3-container w3-content" style="max-width:1400px;margin-top:80px">    
          ...
          <div class="w3-row">
            ...
            <div class="w3-col m3">
              ...
              <div class="w3-card w3-round w3-white">
                <div class="w3-container">
                 ...
                 <p class="w3-center"><img src="<?= URLROOT ?>/public/img/upload/userImg/<?= $data['user']['img'] ?>" class="w3-circle" style="height:106px;width:106px" alt="Avatar"></p>
                 <hr>
                ...
                <div class="w3-col m12">
                  <div class="w3-card w3-round w3-white">
                    <div class="w3-container w3-padding">
                      <h6 class="w3-opacity">Write a Fast  Post</h6>
            ...
            <!-- Post Component -->
            <?php
              require APPROOT . '/views/includes/home/postComponent.php';
            ?>
            <!-- Post Component -->
